...
Your SOLE job is to detect fabricated or hallucinated information. Do NOT evaluate if the optimized content matches the traveler query, and do NOT check if any gaps were addressed. Your ONLY concern is whether the optimizer hallucinated new information not present in the original profile.
...
CRITICAL RULE: PASS profiles that faithfully represent the original data. FAIL profiles that fabricate information. Do not evaluate anything else.
